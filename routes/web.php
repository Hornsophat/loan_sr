...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('property/loan_view', 'PropertyController@index')->name('property/loan_view');
    ...
    Route::get('property/{id}/duplicate', 'PropertyController@duplicate')->name('property.duplicate');
   ...
   // Route::resource('items', 'ProductController');
    ...
    Route::match(['get', 'post'],'general_expense/{id}/receipt_expense', 'GeneralExpenseController@receipt_expense')->name('general_expense.receipt_expense');
    ...
    Route::match(['get', 'post'],'property/edit_booking_detail/{id}', 'SalePropertyController@edit_booking_detail')->name('sale_property.edit_booking_detail');
    ...
    Route::match(['get', 'post'],'property/delete_booking_detail/{id}', 'SalePropertyController@delete_booking_detail')->name('sale_property.delete_booking_detail');
