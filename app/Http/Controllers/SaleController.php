...
class SaleController extends Controller
{
    ...
    public function contract($id){
        ...
        if($sale){
            ...
            $loan = DB::table('loans')->where('sale_id',$sale->id)->skip(1)->first();
    ...
    public function contractLand($id){
        ...
        if($sale){
            ...
            '))
            ->where('property_id', '=', $sale->property_id)
            ...
            //get first deposit
            $reservation->amount = $reservation->amount-DB::table('book_details')->where('reservation_id',$reservation->id)->sum('amount');
            
            return view('back-end.sale.contractLand', compact('reservation','book_details','loans','payment_schedule','sale','child_item','sale_details','property_type', 'property_type_group', 'property_type_extension', 'land', 'properties', 'payments','loan'));
        }
        else{
            return redirect()->back()->with('message', 'Not Found!');
        }
    ...
    public function contractother($id){
        ...
        if($sale){
            ...
            return view('back-end.sale.contractother', compact('sale','child_item','sale_details','property_type', 'property_type_group', 'property_type_extension', 'land', 'properties', 'payments','loan'));
        }
        else{
            return redirect()->back()->with('message', 'Not Found!');
        }
