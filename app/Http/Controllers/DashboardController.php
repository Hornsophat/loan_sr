...
class DashboardController extends Controller
{
    ...
    public function index()
    {
       ...
       // $items = Payment::where('payment_date','>=',$now)->where('payment_date','<=',$end)->where('status','<>',2)->paginate(10);
        ...
        ->get();
        return view('back-end/dashboard/dashboard', compact("loan_simple","loan_eoc","loan_emi","loan_free","lat_lon","land", "project", "property", "users", "output", "total_deposit", "total_sale","items","approve_cancel_payments","projectzones","propertytype"));
    }
    /**
