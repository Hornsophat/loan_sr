    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            @if(Auth::user()->can('list-project') || Auth::user()->can('list-project-zone') || $isAdministrator)
                <!-- Project Action -->
                <li style = "display:;" class="treeview {{Request::is('project/create', 'project','project/*/edit', 'projectzone', 'projectzone/create', 'projectzone/*/edit')?'is-expanded':''}}"><a class="app-menu__item {{Request::is('project/create', 'project','project/*/edit', 'projectzone', 'projectzone/create', 'projectzone/*/edit')?'active':''}}" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-university"></i><span class="app-menu__label">{{ __('item.project') }}</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu">
