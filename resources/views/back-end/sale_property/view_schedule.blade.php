                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <div>
                                @if($loan)
                                <p style="font-family: Khmer os; font-size:18px;"><b>ចំណាំ៖</b> អតិថិជនឈ្មោះ <b>{{ $customer->last_name .' '. $customer->first_name }}</b> ត្រូវបង់ប្រាក់ចំនួន <b>$ {{ $loan->outstanding_amount }} ({{ AppHelper::khNumberWord($loan->loan_amount) }}ដុល្លាអាមេរិក)</b> ក្នុងខែទី <b>១៣</b> មកកាន់ក្រុមហ៊ុន ឬ បង់រំលោះជាមួយធនាគារ</p>
                                @endif
                                <tr>
