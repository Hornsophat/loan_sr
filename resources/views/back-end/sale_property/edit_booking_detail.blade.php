    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">{{ __('item.edit_booking_detail') }}</a></li>
            </ul>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h3>{{ __('item.edit_booking_detail') }}</h3><hr/>
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::model(array('url' => route('sale_property.edit_booking_detail',['id'=>$detail->id]) , 'method' => 'POST', 'files' => true)) !!}
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            {!! Form::text('date', date('d-m-Y', strtotime($detail->date)), array('class' => 'form-control date-picker', 'style'=>'cursor:pointer;','autocomplete' => 'off', 'placeholder' => 'dd-mm-yyyy')) !!}
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            {!! Form::text('deposit', $detail->amount*1, array('class' => 'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")) !!}
                                            <div class="input-group-append">
                                                <span class="input-group-text" >$</span>
                                            </div>
