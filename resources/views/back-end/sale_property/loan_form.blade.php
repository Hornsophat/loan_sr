                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-12 mb-3"> 
                                               <div class="input-group" style="font-family: 'Times New Roman', Times, serif">
                                                    {!! HTML::decode(Form::label('date', trans('item.date').'<span class="required">*</span>', array('style'=>'width:100%;'))) !!}
                                       ...
                                       <div class="row">
                                           <div class="col-md-12 mb-3"> 
                                               <div class="input-group" style="font-family: 'Times New Roman', Times, serif">
                                                    ...
                                                    {!! Form::text('amount', $sale_item->grand_total*1, array('class' => 'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")) !!}
                                                    <div class="input-group-append">
