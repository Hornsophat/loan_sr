                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td style="width: 200px;">{{ trans('item.date') }}</td>
                                            ...
                                            <tr>
                                                <td style="width: 200px;">{{ trans('item.property') }}</td>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-10 ">
                                        ...
                                        {{-- <a style="margin-left:12px" class="btn btn-sm btn-primary pull-left"  href="{{ route('sale.contractother',['id'=>$sale->id]) }}">{{ __('contract other') }}</a> --}}
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table_nowrap">
                                                   ...
                                                   <tbody id="scheduleContent">
                                                        ...
                                                        $index=1;
                                                    @endphp
                                                    <tr @if($loan_first->status=='cancel') style="background: #ca7b7b54" @endif>
                                                        <td>{{ $index }}</td>
