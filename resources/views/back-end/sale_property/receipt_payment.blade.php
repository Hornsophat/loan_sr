                        ...
                        <div class="body">
                            ...
                            <p class="text-justify f-kh" style="text-align: justify-all;">
                               ...
                               <!-- <span class="f-kh" style="min-width:120px">លេខកិច្ចសន្យា / Agreement No:</span>
                                <span class="horizontal_dotted_lines" style=";min-width: 80px">&nbsp;00{{$loan->sale_id}}</span>-->
                                <br>
                               ...
                               <span class="f-kh">កាលបរិចេ្ឆទទិញអចលនទ្រព្យ:</span>
                                ...
                                <span class="horizontal_dotted_lines" style="min-width: 100px">&nbsp;​$ {{ number_format(    $total_amount_paid ,2) }} </span>​ 
                            (
                                <span class="horizontal_dotted_lines" style="min-width: 270px;font-family:Khmer OS System">&nbsp;​{{ AppHelper::khNumberWord(  $total_amount_paid ,2) }}ដុល្លារអាមេរិក</span>
                                )
                                <br>
                            ...
                            (
                             ...
                             <br>
                               ...
                               $total_oustanding_amount=$oustanding_amount+=$loan->outstanding_amount;  ?>
                                ...
                                <span class="horizontal_dotted_lines" style="min-width: 100px">&nbsp;​$ {{ number_format($total_oustanding_amount,2) }} </span>​ 
                                (
                                    <span class="horizontal_dotted_lines" style="min-width: 270px;font-family:Khmer OS System">&nbsp;​{{ AppHelper::khNumberWord( $total_oustanding_amount,2) }}ដុល្លារអាមេរិក</span>
                                    )
                                <br>
                                ...
                                (
                                    <span class="horizontal_dotted_lines" style=";min-width: 270px;font-family:Khmer OS System">&nbsp;​{{ AppHelper::khNumberWord($payment_schedule->paid,2) }}ដុល្លារអាមេរិក</span>
                                    )
                               <br>
                               <span class="f-kh">ប្រាក់ដែលនៅសល់</span>
                                ...
                                <span class="horizontal_dotted_lines" style=";min-width: 60px;font-family:Khmer OS System">&nbsp;{{ $paid_month }} </span>
                                <span class="f-kh">ឆ្នាំ</span>
                            ...
                            <div class="row f-kh" style="margin: 0px;padding: 0px;">
                                <!-- <div class="col-sm-5" style="overflow: hidden;">
                                    <p style="overflow: hidden; float: right;">
                                        ...
                                        <span class="f-kh">ខែ</span>
                                        <span class="horizontal_dotted_lines" style=";min-width: 60px">&nbsp;{{ $paid_month }} </span>
                                        <span class="f-kh">ឆ្នាំ</span>
