                        ...
                        <div class="body">
                            ...
                            (
                             ...
                             @endif
                                ...
                                <span class="horizontal_dotted_lines" style="min-width: 100px">&nbsp;​$ {{ number_format($loan->outstanding_amount,2) }} </span>​ 
                                (
                                    <span class="horizontal_dotted_lines" style="min-width: 270px;font-family:Khmer OS System">&nbsp;​{{ AppHelper::khNumberWord($loan->outstanding_amount,2) }}ដុល្លារអាមេរិក</span>
                                    )
                                <br>
