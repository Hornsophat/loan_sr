                        ...
                        <div class="footer col-mb-7" >
                            <div class="row f-kh" style="margin: 0px;padding: 0px;">
                                ...
                                <div class="col-md-12" style="background: #22228e; color:white; text-align: center;">
                                    <p class="f-kh p-footer" style="margin-bottom: 100px; margin-top: 5px;">អាស័យដ្ឋាន៖ ភូមិក្បាលស្ពាន1 សង្កាត់ប៉ោយប៉ែត ក្រុងប៉ោយប៉ែត  លេខទូរស័ព្ទ៖ 077 333 156 , 081 333 156</p>
                                </div>
                            </div>
                        </div>
                    </div>
