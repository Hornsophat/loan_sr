<?php $__env->startSection('title', 'Edit Booking Property'); ?>
    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.edit_booking')); ?></a></li>
            </ul>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h3><?php echo e(__('item.edit_booking')); ?></h3><hr/>
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo Form::model(array('url' => route('sale_property.edit_booking',['id'=>$reservation->id]) , 'method' => 'POST', 'files' => true)); ?>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            <?php echo Form::text('date', date('d-m-Y', strtotime($reservation->date_booked)), array('class' => 'form-control date-picker', 'style'=>'cursor:pointer;','autocomplete' => 'off', 'placeholder' => 'dd-mm-yyyy')); ?>
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="form-group">
                                            ...
                                            <?php echo Form::select('customer', $customers,$reservation->customer_id, array('class' => 'form-control', 'id' => 'customer')); ?>
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="form-group">
                                            ...
                                            <?php if($reservation->customer_partner_id): ?>
                                                <?php echo Form::select('customer_partner_id', $customers,$reservation->customer_partner_id, array('class' => 'form-control', 'id' => 'customer_partner_id', 'disabled')); ?>
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            <?php echo Form::text('date_expire', date('d-m-Y', strtotime($reservation->date_expire)), array('class' => 'form-control date-picker', 'style'=>'cursor:pointer;','autocomplete' => 'off', 'placeholder' => 'dd-mm-yyyy')); ?>
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="input-group">
                                            ...
                                            <?php echo Form::text('deposit', $reservation->amount*1, array('class' => 'form-control','oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');")); ?>
                                   ...
                                   <div class="col-md-12 mt-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::textarea('remark', $reservation->remark, array('class' => 'form-control', 'rows'=>3)); ?>
