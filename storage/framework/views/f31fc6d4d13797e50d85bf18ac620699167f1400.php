    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.edit_property')); ?></a></li>
            </ul>
        </div>
        <div class="tile">
            <div class="tile-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h3><?php echo e(__('item.edit_property')); ?></h3><hr/>
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo Form::open(array('url' => 'property/'.$item->id.'/edit', 'files' => true)); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 form-group"  style="font-family: 'Times New Roman', Times, serif">
                                        ...
                                        <?php echo e(Form::select('project', $projects ?? [], $item->project_id ?? '', ['class' => 'form-control project_id'])); ?>
                                    ...
                                    <div class="col-lg-6 form-group"  style="font-family: 'Times New Roman', Times, serif">
                                        ...
                                        <?php echo e(Form::select('project_zone', $project_zones ?? [], $item->item_zone ?? '', ['id' => 'project_zone', 'class' => 'form-control zone_id'])); ?>
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group"  style="font-family: 'Times New Roman', Times, serif">
                                             ...
                                             <?php echo Form::text('land_num',  $item->land_num, array('class' => 'form-control')); ?>
                                ...
                                <div class="row">
                                   <div class="col-md-6"​  style="font-family:Khmer OS System;">
                                       <div class="form-group"  >
                                            ...
                                            <?php echo Form::text('property_name', $item->property_name, array('class' => 'form-control')); ?>
                                   ...
                                   <div class="col-md-6"> 
                                       <div class="form-group"  style="font-family: 'Times New Roman', Times, serif">
                                            ...
                                            <?php echo Form::text('property_no', $item->property_no, array('class' => 'form-control')); ?>
