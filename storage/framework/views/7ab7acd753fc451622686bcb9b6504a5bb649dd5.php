<?php $__env->startSection('title',"Purchase Detail Report"); ?>
	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.purchase_detail_report')); ?></a></li>
	        </ul>
      	</div>
		<div class="row">
        	<div class="col-md-12">
				<?php echo $__env->make('flash/message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          		<div class="tile">
            		<div class="tile-body bg-white rounded overflow_hidden p-4">
						<div class="rows">
							<form action="<?php echo e(url('purchase_detail_report')); ?>" method="get" class="form-inline" id="frmSubmit">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<h3><?php echo e(__('item.purchase_detail_report')); ?></h3>
							</div>
						</div>
						<br>
						...
						<table class="table table-hover table-bordered">
			                <thead>
			                  	<tr>
				                    ...
				                    <th class="text-center"><?php echo e(__('item.sub_total')); ?></th>
			                  	</tr>
			                </thead>
	                		<tbody>
	                			<?php
	                			...
	                			<?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				                	...
				                	<tr>
					                    ...
					                    <td class="text-center">$ <?php echo e(number_format($item->cost,2)); ?></td>
					                    <td class="text-center"><?php echo e($item->quantity); ?></td>
					                    <td>$ <?php echo e(number_format($item->total,2)); ?></td>
					                </tr>
				                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				                <tr>
				                	<th colspan="7" style="text-align: right;"><?php echo e(__('item.total')); ?></th>
