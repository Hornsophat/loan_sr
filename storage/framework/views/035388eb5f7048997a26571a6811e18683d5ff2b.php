	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.sale_report')); ?></a></li>
	        </ul>
      	</div>
		<div class="row">
        	<div class="col-md-12">
				<?php echo $__env->make('flash/message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          		<div class="tile">
            		<div class="tile-body bg-white rounded overflow_hidden p-4">
						<div class="rows">
							<form action="<?php echo e(url('sale_report')); ?>" method="get" class="form-inline" id="frmSubmit">
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<?php echo e(Form::select('project', $projects,$request->project,['class' => 'form-control width-100'])); ?>
						...
						<div class="row mt-4">
							<div class="col-md-12 text-center">
								<h3 style="text-transform: uppercase;"><?php echo e(__('item.sale_report')); ?></h3>
							</div>
						</div>
							...
							<table class="table table-hover table-bordered">
				                <thead>
				                  	<tr>
					                    ...
					                    <th class="text-center"><?php echo e(__('item.total_item')); ?></th>
		                		...
		                		<tbody>
		                			...
		                			<?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>	
					                	...
					                	<tr>
											...
											<td class="text-center"><?php echo e($item->customer_name); ?></td>
						                    <td class="text-center"><?php echo e($qty); ?></td>
											<td class="text-center"><?php echo e("$ ". number_format($item->total_price,2)); ?></td>
						                    <td class="text-center"><?php echo e("$ ". number_format($item->discount_amount,2)); ?></td>
						                    <td class="text-center"><?php echo e("$ ". number_format($item->grand_totals,2)); ?></td>
						                </tr>
					                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				                	<tr>
				                		<td colspan="5" style="text-align: right;"><?php echo e(__('item.total')); ?></td>
				                		<td class="text-center"><?php echo e($total_qty); ?></td>
				                		<td class="text-center"><?php echo e("$ ". number_format($total_price,2)); ?></td>
				                		<td class="text-center"><?php echo e("$ ". number_format($total_discount,2)); ?></td>
				                		<td class="text-center"><?php echo e("$ ". number_format($grand_total,2)); ?></td>
				                	</tr>
				                </tbody>
		              		</table>
	              		</div>
