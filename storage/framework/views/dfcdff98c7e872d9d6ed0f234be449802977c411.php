...
<?php $__env->startSection('title',"Receipt Report"); ?>
	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.receipt_report')); ?></a></li>
	        </ul>
      	</div>
		<div class="row">
        	<div class="col-md-12">
				<?php echo $__env->make('flash/message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          		<div class="tile">
            		<div class="tile-body bg-white rounded overflow_hidden p-4">
						<div class="rows">
							<form action="<?php echo e(url('payment_report')); ?>" method="get" class="form-inline" id="frmSubmit">
								<div class="col-md-4">
						...
						<div class="row mt-4">
							<div class="col-md-12 text-center">
								<h3><?php echo e(__('item.receipt_report')); ?></h3>
							</div>
						</div>
	                		...
	                		<tbody>
	                			...
	                			<?php ($total_amount+=$row->amount); ?>
				                	<tr>
				                		...
				                		<td><?php echo e(AppHelper::khMultipleNumber($row->payment_day)); ?>-<?php echo e(AppHelper::khMonth($row->payment_month)); ?>-<?php echo e(AppHelper::khMultipleNumber($row->payment_year)); ?></td>
				                		<td><?php echo e($row->customer_name); ?></td>
				                		<td><?php echo e($row->project_name); ?></td>
				                		<td><?php echo e($row->property_name); ?></td>
				                		<td class="text-right">$<?php echo e($row->pay_amount); ?></td>
					                </tr>
