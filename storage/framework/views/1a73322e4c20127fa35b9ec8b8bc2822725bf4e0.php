                    ...
                    <div class="content-printer clearfix" id="table_print" style="background: #a59b9b1f">
                        ...
                        <div class="body">
                            ...
                            <p class="text-justify f-kh" style="text-align: justify-all;">
                                ...
                                <span class="horizontal_dotted_lines" style="min-width: 195px">&nbsp;<?php echo e(strtoupper($customer->last_name_en.' '.$customer->first_name_en)); ?> </span>
                                <span class="f-kh">ភេទៈ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 60px">&nbsp;<?php echo e($gender); ?> </span>
                                <span class="f-kh">អាយុៈ</span><span class="horizontal_dotted_lines" style="min-width: 30px">&nbsp;<?php echo e($old); ?></span>
                                ...
                                <span style="min-width: 170px">&nbsp;ផ្លូវលេខ <b><?php echo e($customer->street_number); ?></b> ផ្ទះលេខ <b><?php echo e($customer->house_number); ?></b>  ភូមិ <b> <?php echo e($address-> dis_kh); ?>  </b> ឃុំ/សង្កាត់ <b><?php echo e($address->com_kh); ?></b>  ​ស្រុក/ខណ្ឌ <b><?php echo e($address->dis_kh); ?></b> រាជធានី/ខេត្ត <b><?php echo e($address->prov_name); ?></b>  </span>
                                <br>
                                <span class="f-kh">កាន់អត្តសញ្ញាណប័ណ្ណលេខៈ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 140px">&nbsp;<?php echo e($customer->identity); ?></span>
                                <br>
                                <span class="f-kh">បានទិញផ្ទះ/ដីឡូត៍លេខៈ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 100px">&nbsp;<?php echo e($property->property_no); ?></span>
                                
                                <br>    
                                <span class="f-kh">គម្រោងៈ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 150px">&nbsp;<?php echo e($project->property_name); ?> </span>
                                <br>
                                <span class="f-kh">តម្លៃផ្ទះ/ដីឡូត៍ៈ​</span>
                                <span class="horizontal_dotted_lines" style="min-width: 10px">&nbsp;​$<?php echo e(number_format($property->property_price,2)); ?> </span>
                                (
                                <span class="horizontal_dotted_lines" style="min-width: 160px">&nbsp;​<?php echo e(AppHelper::khNumberWord($property->property_price)); ?>ដុល្លារអាមេរិក</span>
                                )
                                <br>
                                <span class="f-kh">ទឹកប្រាក់ដែលបានកក់</span>
                                <span class="horizontal_dotted_lines" style="min-width: 20px">&nbsp;​$<?php echo e(number_format($paid,2)); ?> </span>
                                (
                                <span class="horizontal_dotted_lines" style="min-width: 60px">&nbsp;​<?php echo e(AppHelper::khNumberWord($paid)); ?>ដុល្លារអាមេរិក</span>
                                )
                                <br>

                                <span class="f-kh">កាលបរិច្ឆេទបង់ប្រាក់ថ្ងៃទី</span>
                                <span class="horizontal_dotted_lines" style="min-width: 30px">&nbsp;​<?php echo e($paid_day_number); ?> </span>
                                <span class="f-kh">ខែ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 75px">&nbsp;<?php echo e($paid_month); ?> </span>
                                <span class="f-kh">ឆ្នាំ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 50px">&nbsp;<?php echo e($paid_year); ?> </span>
                                <span class="f-kh">កាលបរិច្ឆេទត្រូវផុតកំណត់</span>
                                <span class="horizontal_dotted_lines" style="min-width: 30px">&nbsp;​<?php echo e($paid_day_number_next); ?> </span>
                                <span class="f-kh">ខែ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 75px">&nbsp;<?php echo e($paid_month_next); ?> </span>
                                <span class="f-kh">ឆ្នាំ</span>
                                <span class="horizontal_dotted_lines" style="min-width: 50px">&nbsp;<?php echo e($paid_year_next); ?> </span>
                                <br>
                                <span class="f-kh"​ style="font-weight:bold">ចំណាំ៖ រាល់ការបង់ប្រាក់រួចមិនអាចដកវិញបានទេ។</span>
                            </p>
                        </div>
                        <div class="footer">
                            <div class="row f-kh" style="margin: 0px;padding: 0px;">
                                <!-- <div class="col-sm-12" style="overflow: hidden;">
                                    <p style="overflow: hidden; float: right;">
                                        ...
                                        <span class="f-kh">ខែ</span>
                                        <span class="horizontal_dotted_lines" style="min-width: 80px">&nbsp;<?php echo e($paid_month); ?> </span>
                                        <span class="f-kh">ឆ្នាំ</span>
                                ...
                                <div class="col-md-12" style="background: #22228e; color:white; text-align: center;">
                                    <p class="f-kh p-footer" style="margin-bottom: 12px; margin-top: 10px;">ការិយាល័យលក់៖ ភូមិល្អក់ ឃុំ​​ កណ្តែក  ស្រុក ​ប្រាសាទបាគង ខេត្តសៀមរាប <br> លេខទូរស័ព្ទ៖ 077 333 156 , 081 333 156</p>
                                </div>
                            </div>
                        </div>
                    </div>
