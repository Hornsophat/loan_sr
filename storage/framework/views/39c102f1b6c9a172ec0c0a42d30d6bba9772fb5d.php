    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.add_booking')); ?></a></li>
            </ul>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h3><?php echo e(__('item.add_booking')); ?></h3><hr/>
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo Form::model(array('url' => route('sale_property.add_booking',['id'=>$reservation->id]) , 'method' => 'POST', 'files' => true)); ?>
