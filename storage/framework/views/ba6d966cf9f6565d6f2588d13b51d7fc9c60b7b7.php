<?php $__env->startSection('title',"Add Expense Group"); ?>
	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.add_expense_type')); ?></a></li>
	        </ul>
      	</div>
        <div class="col-lg-12">
            <?php echo $__env->make('flash/message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          	<div class="panel-body bg-white rounded overflow_hidden p-4">
          		<h3 class="text-dark mb-4"><?php echo e(__('item.add_expense_type')); ?></h3><hr/>

                <form action="<?php echo e(route('expense_group.create')); ?>" method="POST" class="row form-horizontal" enctype="multipart/form-data">
