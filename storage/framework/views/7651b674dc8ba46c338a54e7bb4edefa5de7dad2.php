	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.add_expense')); ?></a></li>
	        </ul>
      	</div>
        <div class="col-lg-12">
            <?php echo $__env->make('flash/message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          	<div class="panel-body bg-white rounded overflow_hidden p-4">
          		<h3 class="text-dark mb-4"><?php echo e(__('item.add_expense')); ?></h3><hr/>

                <form action="<?php echo e(route('general_expense.create')); ?>" method="POST" class="row form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group d-lg-flex align-items-center<?php echo e($errors->has('date') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-lg-9 p-0">
                                    <input type="text" name="date" class="form-control demoDate" value="<?php echo e(date('d-m-Y')); ?>" id="date" required >
                            ...
                            <div class="col-md-12 form-group d-lg-flex align-items-center<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-lg-9 p-0">
                                    <input type="text" name="title" class="form-control" value="<?php echo e(old('title')); ?>" required autofocus>
                            ...
                            <div class="col-md-12 form-group d-lg-flex align-items-center<?php echo e($errors->has('amount') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-lg-9 p-0">
                                    <input type="text" id="amount" name="amount" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" min="0" value="<?php echo e(old('amount')); ?>" required>
                            ...
                            <div class="col-md-12 form-group d-lg-flex align-items-center<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-lg-9 p-0">
                                    <textarea rows="3" name="description" class="form-control" ><?php echo e(old('description')); ?></textarea>
