											...
											<td>
												<p class="p"><b>&emsp;៤.១.</b> 
													<ul>
														...
														<tr>
															<td align="left" style="font-family: 'Khmer OS system">
														&emsp;&emsp;​​​​​​​​​​ <b>៤.១.១. ដំណាក់កាលទី១</b>  ៖ ភាគី “ខ” យល់ព្រមបង់ប្រាក់កក់ចំនួន $  <b><?php echo e($sale->deposit); ?></b><b>(​<?php echo e(AppHelper::khNumberWord( $sale->deposit)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->created_at)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($sale->created_at)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->created_at)))); ?></b>។
															</td>
														</tr>
														<tr>
															<td align="left" style="font-family: 'Khmer OS system">
														&emsp;&emsp; <b>៤.១.២. ដំណាក់កាលទី២</b> ៖ ភាគី “ខ” យល់ព្រមបង់ប្រាក់បន្ថែមចំនួន​ $ <b><?php echo e($loan->loan_amount); ?></b> <b>(​<?php echo e(AppHelper::khNumberWord($loan->loan_amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($loan->first_pay_date)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($loan->first_pay_date)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($loan->first_pay_date)))); ?></b>។
															</td>
														</tr>
														<tr>
															<td align="left" style="font-family: 'Khmer OS system">
														&emsp;&emsp; <b>៤.១.៣.	ដំណាក់កាលទី៣</b> ៖ ភាគី “ខ” នឹងបង់ប្រាក់ដែលនៅសល់បង្រ្គប់ចំនួន $ <b><?php echo e($last_balance); ?> </b>  <b>(​<?php echo e(AppHelper::khNumberWord( $last_balance)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($effectiveDate)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($effectiveDate)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($effectiveDate)))); ?></b> ហើយភាគី “ក” ត្រូវបញ្ចប់ការសាងសង់ និងកាត់ឈ្មោះផ្ទេរកម្មសិទ្ធិរួចរាល់ជាស្ថាពរឲ្យទៅភាគី“ខ” ហើយភាគី “ក” ត្រូវប្រគល់ប័ណ្ណកម្មសិទ្ធិដែលបានផ្ទេរសិទ្ធិទៅភាគី “ខ” រួចរាល់នោះ ឲ្យទៅភាគី “ខ” ។
															</td>
														</tr>
														<tr>
						...
						<tr>
							<td align="left"style="font-family: 'Khmer OS System';">&emsp;&emsp;&emsp;&emsp; <b>-និងរក្សាទុកនៅការិយាល័យមេធាវីចំនួន០១ ច្បាប់។</b> </td>
										...
										<table class="text-center" style="width:100%;font-size:15px;height:350px;margin-top:-70px;font-family:Khmer OS System">
											...
											<td>&emsp;&emsp;​ <b><?php echo e($sale->customer_name); ?></b> <br> <span style="font-family: Khmer OS System;font-weight:bold;margin-left:30px">(ភាគីអ្នកទិញ)</span></td>
											</tr>
										</table>
												...
												<div class="content">
													...
													if($child_item!==[])
													{
														...
														<?php
															...
															<tr>
																<td align="left"​>&emsp;&emsp;២.ភាគី«ខ»បានយល់ព្រមបង់ដំណាក់កាលទី១ កក់បិតផ្ទះ​​ $  <b><?php echo e($sale->deposit); ?></b><b>(​<?php echo e(AppHelper::khNumberWord( $sale->deposit)); ?>)</b> ដុល្លារអាមេរិកគត់​​​ នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->created_at)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($sale->created_at)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->created_at)))); ?></b>។</td>
															</tr>
															<tr>
																<td align="left"​><b>ដំណាក់កាលទី២</b> ភាគី«ខ»យល់ព្រមបង់បន្ថែមបង្រ្គប់ តម្លៃស្មើនឹង$ <b><?php echo e($loan->loan_amount); ?></b> <b>(​<?php echo e(AppHelper::khNumberWord($loan->loan_amount)); ?>) ដុល្លារអាមេរិកគត់</b>  ឪ្យទៅភាគី«ក»</td>
															</tr>
															<tr>
																<td align="left"​><b>ដំណាក់កាលទី៣</b> ភាគី«ខ»នឹងបង់រំលោះចំនួនចាប់ពី ៥០០$(ប្រាំរយដុល្លារ)ឡើងទៅ ក្នុងមួយខែ រហូតដល់១២ខែ(១ឆ្នាំ)គិតចាប់ពីថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($loan->first_pay_date)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($loan->first_pay_date)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($loan->first_pay_date)))); ?></b></td>
															</tr>
															<tr>
															...
															<tr>
																<td align="left"​>-ថែមជូន <b><?php echo e($sale->product_first); ?></b></td>
															</tr>
															<tr>
																<td align="left"​>-ថែមជូន <b><?php echo e($sale->product_second); ?></b></td>
															</tr>
															<tr>
																<td align="left"​>-ថែមជូន <b><?php echo e($sale->product_third); ?></b></td>
															</tr>
															<tr>
																<td align="left"​>-ថែមជូន <b><?php echo e($sale->product_four); ?></b></td>
															</tr>
															<tr>
																<td align="left"​>-ថែមជូនជាពិសេសសម្រាប់បន្ទប់មេគ្រួសារមានដូចជា៖ <b><?php echo e($sale->product_five); ?></b> </td>
															</tr>
															<tr>
															...
															<tr>
																<td align="right"​>ធ្វើនៅសៀមរាប ថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->created_at)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($sale->created_at)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->created_at)))); ?></b></td>
															</tr>
															<tr>
																<td></td>
															</tr>
