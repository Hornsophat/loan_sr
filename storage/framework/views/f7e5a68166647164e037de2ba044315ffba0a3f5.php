...
<?php $__env->startSection('title',"Property Price Report"); ?>
				...
				<?php echo $__env->make('flash/message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          		<div class="tile">
            		<div class="tile-body bg-white rounded overflow_hidden p-4">
						<div class="rows">
							<form action="<?php echo e(url('property_price_report')); ?>" method="get" class="form-inline" id="frmSubmit">
								<div class="col-md-4">
						...
						<div class="row mt-2">
							<div class="col-md-12 text-center">
								<h3 style="text-transform: uppercase;"><?php echo e(__('item.property_price_report')); ?></h3>
							</div>
						</div>
							...
							<table class="table table-hover table-bordered">
				                <thead>
				                  	<tr>
					                    ...
					                    <th><?php echo e(__('item.property_no')); ?></th>
					                    <th><?php echo e(__('item.property_name')); ?></th>
					                    <th><?php echo e(__('item.project_name')); ?></th>
					                    <th><?php echo e(__('item.zone_name')); ?></th>
		                		...
		                		<tbody>
		                			<?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>						
					                	<tr>
						                    ...
						                    <td class="text-center"><?php echo e($item->property_date); ?></td>
						                    ...
						                    <td class="text-right">$<?php echo e($item->property_price); ?></td>
						                </tr>
