    ...
    <main class="app-content">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.add_project_zone')); ?></a></li>
            </ul>
        </div>
        <div class="tile">
            <div class="tile-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <h3><?php echo e(__('item.add_zone')); ?></h3><hr/>
                            <div class="panel-body">
                                ...
                                <?php echo Form::open(array('url' => 'projectzone/create')); ?>


                                <div class="form-group">
                                    <?php echo Form::label('zone_name', trans('item.zone_name'))."<span class='star'> *</span>"; ?>

                                    <?php echo Form::text('zone_name', Input::old('zone_name'), array('class' => 'form-control')); ?>

                                </div>

                                <div class="form-group">
                                    <?php echo Form::label('zone_code', trans('item.zone_code'))."<span class='star'> *</span>"; ?>

                                    <?php echo Form::text('zone_code', Input::old('zone_code'), array('class' => 'form-control')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="project" id="project" class="form-control">
                                        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($project->id); ?>"><?php echo e($project  ->property_name); ?></option>
