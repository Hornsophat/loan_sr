						...
						<div id="table_print">
							...
							<div class="row">
								<div class="col-sm-6 col-md-6">									
									<p>អតិថិជន : <?php echo e($customer->last_name.' '.$customer->first_name); ?></p>
									<p>ទូរស័ព្ទ : <?php echo e($customer->phone1.' '.$customer->phone2); ?></p>
									<p>អាសយដ្ឋាន : <?php echo e(isset($customer->eVillage->village_namekh)?$customer->eVillage->village_namekh:"".', '.isset($customer->eCommune->commune_namekh)?$customer->eCommune->commune_namekh:"".', '.isset($customer->eDistrict->district_namekh)?$customer->eDistrict->district_namekh:"".', '.isset($customer->eProvince->province_kh_name)?$customer->eProvince->province_kh_name:""); ?></p>
								</div>
								<div class="col-sm-6 col-md-6">
									<div style="position:relative;left: 50%;">
										<p>អចលនទ្រព្យ : <?php echo e($sale_item->property_name); ?></p>
										<p>ប្រាក់កម្ចី : $<?php echo e(number_format($loan->loan_amount,2)); ?></p>
			               ...
			               <thead>
		                  	<tr>
			                    	...
			                    	<th class="text-center"><?php echo e(__('ថ្ងៃ-ខែ-ឆ្នាំ​ បង់ប្រាក់')); ?></th>
										<th class="text-center"><?php echo e(__('ប្រាក់ត្រូវបង់')); ?></th>
			                    	<th class="text-center"><?php echo e(__('ថ្ងៃ-ខែ-ឆ្នាំ​ បង់ប្រាក់ជាក់ស្ដែង')); ?></th>
			                    	<th class="text-center"><?php echo e(__('ប្រាក់ទទួល')); ?></th>
			                    	<th class="text-center"><?php echo e(__('ផ្សេងៗ')); ?></th>
		                  	</tr>
			               </thead>
	                		<tbody>
