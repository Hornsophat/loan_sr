                        ...
                        <div class="body">
                            ...
                            <p class="text-justify f-kh" style="text-align: justify-all;">
                               ...
                               <span class="f-kh" style="min-width:120px">លេខកិច្ចសន្យា / Agreement No:</span>
                                <span class="horizontal_dotted_lines" style=";min-width: 80px">&nbsp;00<?php echo e($loan->sale_id); ?></span><br>    
                               ...
                               <span class="f-kh">កាលបរិចេ្ឆទទិញអចលនទ្រព្យ:</span>
                                ...
                                <span class="horizontal_dotted_lines" style=";min-width: 120px;">&nbsp;​$ <?php echo e($payment_transaction->amount); ?> </span>
                                (
                                <span class="horizontal_dotted_lines" style=";min-width: 270px;font-family:Khmer OS System">&nbsp;​<?php echo e(AppHelper::khNumberWord($payment_transaction->amount)); ?>ដុល្លារអាមេរិក</span>
                                )
                                <br>
                                <span class="f-kh">ទឹកប្រាក់ដែលនៅសល់:​</span>
                                <span class="horizontal_dotted_lines" style=";min-width: 120px;">&nbsp;​$ <?php echo e($balance_last); ?> </span>
                                (
                                <span class="horizontal_dotted_lines" style=";min-width: 270px;font-family:Khmer OS System">&nbsp;​<?php echo e(AppHelper::khNumberWord( $balance_last)); ?>ដុល្លារអាមេរិក</span>
                                )
                                <br>
                                ...
                                (
                                    <span class="horizontal_dotted_lines" style=";min-width: 270px;font-family:Khmer OS System">&nbsp;​<?php echo e(AppHelper::khNumberWord( $payment_schedule->amount_to_spend,2)); ?>ដុល្លារអាមេរិក</span>
                                    )
                                    <br> 
                                ...
                                <span class="f-kh" style="color: red">កំណត់ចំណាំ: <?php echo e($payment_transaction->remark); ?></span>
                                <?php endif; ?>
                                <br>   
