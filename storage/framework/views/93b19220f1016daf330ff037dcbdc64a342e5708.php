                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive">
                            <div class="header">
                                ...
                                <div class="title">
                                    <p style="margin-bottom: 0;"><span style="font-family: Khmer OS;font-size:20px;font-weight:bold"><b>លេខទូរស័ព្ទ៖ 077 333 156 , 081 333 156</b></span></p>
                                </div>
                                <br><br>
                                <div class="title">
                            ...
                            <div>
                                <?php if($loan): ?>
                                <p style="font-family: Khmer os; font-size:18px;"><b>ចំណាំ៖</b> អតិថិជនឈ្មោះ <b><?php echo e($customer->last_name .' '. $customer->first_name); ?></b> ត្រូវបង់ប្រាក់ចំនួន <b>$ <?php echo e($loan->outstanding_amount); ?> (<?php echo e(AppHelper::khNumberWord($loan->loan_amount)); ?>ដុល្លាអាមេរិក)</b> ក្នុងខែទី <b>១៣</b> មកកាន់ក្រុមហ៊ុន ឬ បង់រំលោះជាមួយធនាគារ</p>
                                <?php endif; ?>
                                <tr>
