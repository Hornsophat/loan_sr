<?php $__env->startSection('title',"Deposit Report"); ?>
	...
	<main class="app-content">
		<div class="app-title">
	        <ul class="app-breadcrumb breadcrumb side">
	          	...
	          	<li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.deposit_report')); ?></a></li>
	        </ul>
      	</div>
		<div class="row">
        	<div class="col-md-12">
				<?php echo $__env->make('flash/message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          		<div class="tile">
            		<div class="tile-body bg-white rounded overflow_hidden p-4">
						<div class="rows">
							<form action="<?php echo e(url('deposit_report')); ?>" method="get" class="form-inline">
						...
						<div class="row mt-4">
							<div class="col-md-12 text-center">
								<h3><?php echo e(__('item.deposit_report')); ?></h3>
							</div>
						</div>
						...
						<table class="table table-hover table-bordered">
			                <thead>
			                  	<tr>
				                    ...
				                    <th class="text-center"><?php echo e(__('item.deposit')); ?></th>
				                    <th class="text-center"><?php echo e(__('item.total')); ?></th>
				                    <th class="text-center"><?php echo e(__('item.item')); ?></th>
				                    <th class="text-center"><?php echo e(__('item.process')); ?></th>
			                  	</tr>
			                </thead>
	                		<tbody>
	                			<?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				                	...
				                	<tr>
										...
										<td class="text-center"><?php echo e("$ ". number_format($item->deposit + $item->total_price,2)); ?></td>
					                    <td class="text-center"><?php echo e("$ ". ($item->total_discount !=null?$item->total_discount:"0.00")); ?></td>
					                    <td class="text-center"><?php echo e("$ ". $item->total_sale_commission); ?></td>
					                    <td class="text-center"><?php echo e("$ ". $item->deposit); ?></td>
					                    <td class="text-center"><?php echo e("$ ". $item->grand_total); ?></td>
					                    <td class="text-center"><?php echo e($item->salesDetail()->count()); ?></td>
					                    <td class="text-center"><?php echo e(number_format($percentage,2) ."%"); ?></td>
					                </tr>
