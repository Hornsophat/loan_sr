<script type="text/javascript">
       function view_payment(property,payment_schedule,customer){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('sale_property.view_sale_first_payment')); ?>",
        ...
        function view_loan_payment(payment_schedule){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('sale_property.view_loan_payment')); ?>",
        ...
        function view_loan_schedule(loan){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('sale_property.view_loan_schedule')); ?>",
                data:{loan:loan},
                success:function(data){
        ...
        function view_schedule(loan){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('sale_property.view_schedule')); ?>",
                data:{loan:loan},
                success:function(data){
        ...
        function confirmAlert(){
            var log = swal({
                title: "<?php echo e(__('item.confirm_cancel_payment')); ?>",
                type: "warning",
                ...
                if (confirm) {
                    $.ajax({
                        ...
                        success:function(data){
                            if(data.message==1){
                                swal({
                                    title: '<?php echo e(__('item.success_cancel_loan_payment')); ?>',
                                    type: "success",
                                ...
                                swal({
                                    title: '<?php echo e(__('item.error_cancel_loan_payment')); ?>',
                                    type: "warning",
                                    showCancelButton: false,
                                    confirmButtonText: "<?php echo e(__('item.ok')); ?>",
                                    closeOnConfirm: false,
        ...
        function cancel_loan(loan){
            swal({
                title: "<?php echo e(__('item.confirm_cancel_loan')); ?>",
                text: "",
                type: "warning",
                showCancelButton: true,
                confirmButtonClass: "btn-danger",
            ...
            function(confirm) {
                if (confirm) {
                    $.ajax({
                        type:'get',
                        url:"<?php echo e(route('sale_property.cancel_loan')); ?>",
                        data:{loan:loan},
                        success:function(data){
                            if(data.message){
                                swal({
                                    title: '<?php echo e(__('item.success_cancel_loan')); ?>',
                                    type: "success",
                                    showCancelButton: false,
                                    confirmButtonText: "<?php echo e(__('item.ok')); ?>",
                                    closeOnConfirm: false,
                                ...
                                swal({
                                    title: '<?php echo e(__('item.error_cancel_loan')); ?>',
                                    type: "warning",
                                    showCancelButton: false,
                                    confirmButtonText: "<?php echo e(__('item.ok')); ?>",
                                    closeOnConfirm: false,
        ...
        function cancel_sale_payment(payment_transaction){
            ...
            function(confirm) {
                if (confirm) {
                    $.ajax({
                        type:'get',
                        url:"<?php echo e(route('sale_property.cancel_sale_payment')); ?>",
                        data:{payment_transaction:payment_transaction},
                        success:function(data){
                            if(data.message){
                                swal({
                                    title: '<?php echo e(__('item.success_cancel_sale_payment')); ?>',
                                    type: "success",
                                    showCancelButton: false,
                                    confirmButtonText: "<?php echo e(__('item.ok')); ?>",
                                    closeOnConfirm: false,
                                ...
                                swal({
                                    title: '<?php echo e(__('item.error_cancel_sale_payment')); ?>',
                                    type: "warning",
                                    showCancelButton: false,
                                    confirmButtonText: "<?php echo e(__('item.ok')); ?>",
                                    closeOnConfirm: false,
        ...
        function cancel_sale(sale){
            swal({
                title: "<?php echo e(__('item.confirm_cancel_sale')); ?>",
                text: "",
                type: "warning",
                showCancelButton: true,
                confirmButtonClass: "btn-danger",
            ...
            function(confirm) {
                if (confirm) {
                    $.ajax({
                        method:'get',
                        url:"<?php echo e(route('sale_property.cancel_sale')); ?>",
                        data:{sale:sale},
                        success:function(data){
                            if(data.message){
                                swal({
                                    title: '<?php echo e(__('item.success_cancel_sale')); ?>',
                                    type: "success",
                                    showCancelButton: false,
                                    confirmButtonText: "<?php echo e(__('item.ok')); ?>",
                                    closeOnConfirm: false,
                                ...
                                // $('#loanScheduleModal').modal('hide');
                                setTimeout(function(){
                                    location.href = "<?php echo e(route('property')); ?>";
                                },2500)
                            }else{
                                swal({
                                    title: '<?php echo e(__('item.error_cancel_sale')); ?>',
                                    type: "warning",
                                    showCancelButton: false,
                                    confirmButtonText: "<?php echo e(__('item.ok')); ?>",
                                    closeOnConfirm: false,
        ...
        function view_contract(id){
            $.ajax({
                method:'get',
                url:"<?php echo e(route('sale_property.sale_contract')); ?>",
                data:{id:id},
                success:function(data){
        ...
        function print_schedule(id){
            $.ajax({
                method:'get',
                url:"<?php echo e(route('sale_property.print_schedule')); ?>",
                data:{id:id},
                success:function(data){
        ...
        function getChangePartner(){
            $.ajax({
                type:"GET",
                url:"<?php echo e(route('sale_item.getchange_partner')); ?>",
                data:{sale_item_id:"<?php echo e($sale->id); ?>"},
                dataType:false,
                complete:function(response){
                    if(response.status==200){
