...
<?php $__env->startSection('content'); ?>
	<main class="app-content">
        ...
        <ul class="app-breadcrumb breadcrumb side">
          	...
          	<li class="breadcrumb-item"><?php echo e(__('item.contract')); ?></li>
          	<li class="breadcrumb-item active"><a href="#"><?php echo e(__('item.contract')); ?></a></li>
        </ul>
      </div>
        	...
        	<div class="col-md-12" style="height: 40px;">
       		...
       		<div class="tile">
       			<div class="form-group">
       				<button class="btn btn-lg btn-danger" onclick="goBack();"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i><?php echo e(__('item.back')); ?></button>
       				<button class="btn btn-lg btn-success pull-right btnPrint" onclick="printFunc();"><i class="fa fa-print" aria-hidden="true"></i><?php echo e(__('item.print_this_page')); ?></button>
       			</div>          				
       			<hr>
         		<div class="tile-body">
						<style type="text/css">
							...
							@font-face {
								...
								src:url('<?php echo e(asset('public/back-end/fonts/print-font/TACTENG.ttf')); ?>')  format('truetype');
							}
							.table tr{
								padding:0px;
								margin: 0px;
								...
								<div class="content">
									<table class="table">
										<div class="box-logo" style="margin-top: 60px">
											<img src="<?php echo e(Setting::get('LOGO')); ?>" width="50%" height="200%">
										</div>
				                	<tbody>
						<?php
						//datetime next 
					 ...
					 $last_balance=$amount_sale -($amount_booked + $amount_paid);  						
						?>
				                		...
				                		<tr>
											...
											<tr>
												<td style="font-size: 13pt; font-family: 'Khmer OS Muol Light';">កិច្ចសន្យាលក់-ទិញផ្ទះ<?php echo e($sale->about); ?></td>
											</tr>
											<br>
						               ...
						               <tr style="text-align: center">
						                	<td style="tab-size:8"><p class="p" style=" tab-size:8!important;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;កិច្ចសន្យានេះធ្វើឡើងនៅខេត្តសៀមរាប ចុះថ្ងៃទី <?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->created_at)))); ?> ខែ <?php echo e(AppHelper::khMonth(date('m', strtotime($sale->created_at)))); ?> ឆ្នាំ <?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->created_at)))); ?></p></td>
						               </tr> 
									<tr style="text-align: center">
									...
									<br>
					                	...
					                	<tr>
					                		<td>
					                			<p class="p" style="text-align: justify;">&emsp;&emsp;&emsp; <b style="text-decoration:underline">  ភាគីអ្នកទិញ</b> ៖ ឈ្មោះ <span style="font-family: 'Khmer OS Muol Light';"><b><?php echo e($sale->customer_name); ?></b></span>ភេទ <b><?php echo e($sale->customer_gender); ?></b>  កើតនៅ​ ឆ្នាំ​ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->customer_date_of_birht)))); ?> </b> សញ្ជាតិ <b><?php echo e($sale->customer_nationality); ?></b> មានអត្តសញ្ញាណប័ណ្ណសញ្ជាតិខ្មែរលេខៈ <b><?php echo e(AppHelper::khMultipleNumber((string)$sale->customer_identity)); ?></b> ចុះថ្ងៃទី <b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->cs_ident)))); ?> </b> ខែ  <b><?php echo e(AppHelper::khMultipleNumber(date('m', strtotime($sale->cs_ident)))); ?> </b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->cs_ident)))); ?> </b> អាស័យដ្ឋានបច្ចុប្បន្ន​ ផ្លូវលេខ <b><?php echo e($sale->street_number); ?></b> ផ្ទះលេខ <b><?php echo e($sale->cs_house_n); ?></b>  ភូមិ <b> <?php echo e($sale-> vil_kh); ?>  </b> ឃុំ/សង្កាត់ <b><?php echo e($sale->com_kh); ?></b>  ​ស្រុក/ខណ្ឌ <b><?php echo e($sale->dis_kh); ?></b> រាជធានី/ខេត្ត <b><?php echo e($sale->prov_name); ?></b>  ហៅកាត់ភាគី (ខ) ។</p>
					                		</td>
					                	</tr>
										<?php if($sale->customer_partner_id != Null): ?>	
										<tr>
					                		<td>
					                			<p class="p" style="text-align: justify;">&emsp;&emsp;&emsp;<b style="text-decoration:underline">  ភាគីរួមកម្ចី </b>៖ ឈ្មោះ <span style="font-family: 'Khmer OS Muol Light';"><b><?php echo e($sale->partner_name); ?></b></span> ភេទ <b><?php echo e($sale->partner_gender); ?></b>  កើតនៅ ថ្ងៃទី <b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->date_of_birth_partner)))); ?> </b>  ខែ​ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($sale->date_of_birth_partner)))); ?></b>  ឆ្នាំ​ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->date_of_birth_partner)))); ?></b> សញ្ជាតិ <b><?php echo e($sale->customer_nationality); ?></b>  មានអត្តសញ្ញាណប័ណ្ណសញ្ជាតិខ្មែរលេខៈ <b><?php echo e(AppHelper::khMultipleNumber((string)$sale->partner_identity)); ?></b> ចុះថ្ងៃទី <b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->pn_identity_date)))); ?> </b> ខែ <b><?php echo e(AppHelper::khMultipleNumber(date('m', strtotime($sale->pn_identity_date)))); ?></b> ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->pn_identity_date)))); ?> </b> អាសយដ្ឋានបច្ចុប្បន្ន​ ផ្ទះលេខ <b><?php echo e($sale->pn_house_n); ?></b>  ផ្លូវលេខ <b><?php echo e($sale->partner_street_number); ?></b>  ភូមិ <b> <?php echo e($sale-> partner_village); ?>  </b> ឃុំ/សង្កាត់ <b><?php echo e($sale->partner_commune); ?></b>  ក្រុង/ស្រុក/ខណ្ឌ <b><?php echo e($sale->partner_district); ?></b> រាជធានី/ខេត្ត <b><?php echo e($sale->partner_province); ?></b>  ហៅកាត់ភាគី (ខ) ។</p>
					                		</td>
					                	</tr>
										<?php endif; ?>
					                	<tr>
										...
										&emsp;&emsp;&emsp; <b>គូភាគីបានព្រមព្រៀងគ្នាលក់-ទិញផ្ទះ<?php echo e($sale->property_name); ?>មួយកន្លែងដូចខាងក្រោម៖</b> 
										</td>
										</tr>
					                	<tr>
					                		<td>
								                 <ul>
											            	...
											            	<table width="100%">
											            		<tr>
												            		<td width="20.2%" style="padding: 0px;"><p class="p">&emsp;&emsp;&emsp;- ផ្ទះវីឡាលេខ <b><?php echo e($sale->p_pn); ?></b> </p></td>

												            	
												            	</tr>
												            	<tr>
																	<td width="15.2%" style="padding: 0px;"><p class="p">&emsp;&emsp;&emsp;- មានទំហំក្បាលដី <b><?php echo e($sale->land_num); ?></b> ម៉ែត្រ បណ្តោយ <b><?php echo e($sale->address_zip_code); ?></b> ម៉ែត្រ និងទំហំផ្ទះ <b><?php echo e($sale->width); ?> </b> ម៉ែត្រ X <b><?php echo e($sale->length); ?></b> ម៉ែត្រ។</p></td>
												            	
												            	</tr>
																<tr>
																	<td width="20.2%" style="padding: 0px;"><p class="p">&emsp;&emsp;&emsp;- មានព្រំប្រទល់ខាងជើងទល់នឹងផ្ទះលេខ <b><?php echo e($sale->boundary_north); ?></b> ខាងត្បូងទល់នឹងផ្ទះលេខ <?php echo e($sale->boundary_south); ?>  <br> &emsp;&emsp;&emsp;&emsp;ខាងកើតទល់នឹង <b><?php echo e($sale->boundary_east); ?></b> ខាងលិចទល់នឹងផ្ទះលេខ <b><?php echo e($sale->boundary_west); ?></b> ។ </p></td>
					                	...
					                	<tr>
					                		<td>
					                			<div class="margin-top-10">
					                				<p class="p">&emsp;&emsp;គូភាគីបានព្រមព្រៀងគ្នាលក់-ទិញផ្ទះវីឡាទោល​​ ដែលជាកម្មវត្ថុនៃកិច្ចសន្យានេះ ក្នុងតម្លៃសរុបចំនួន $<b><?php echo e($sale->p_pp); ?></b>  ចំនួនទឹកប្រាក់ជាអក្សរ <b> (&nbsp;​<?php echo e(AppHelper::khNumberWord($sale->p_pp)); ?></b> ដុល្លារអាមេរិកគត់)។</p>
					                			</div>
					                		</td>
					                	</tr>
					                	<td align="left"​ style="font-family: 'Khmer OS Muol Light';">
									...
									?>
														...
														if($sale->deposit<=0)
														{
															...
															?>
																<tr>
																	<td align="left" style="font-family: 'Khmer OS system">
																&emsp;&emsp;​​​​​​​​​​ <b>៤.១.<?php echo e(AppHelper::khMultipleNumber($i)); ?>. ដំណាក់កាលទី <?php echo e(AppHelper::khMultipleNumber($i)); ?></b>  ៖ ភាគី “ខ” យល់ព្រមបង់ប្រាក់កក់ចំនួន $  <b><?php echo e(number_format( $reservation->amount,2 )); ?></b><b>(​<?php echo e(AppHelper::khNumberWord( $reservation->amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($reservation->date_booked)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($reservation->date_booked)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($reservation->date_booked)))); ?></b>។
																	</td>
																</tr>
																<!-- get book details -->
																<?php
																	foreach($book_details as $book)
																	{
																		...
																		?>
																			<tr>
																				<td align="left" style="font-family: 'Khmer OS system">
																			&emsp;&emsp;​​​​​​​​​​ <b>៤.១.<?php echo e(AppHelper::khMultipleNumber($i)); ?>. ដំណាក់កាលទី <?php echo e(AppHelper::khMultipleNumber($i)); ?></b>  ៖ ភាគី “ខ” យល់ព្រមបង់ប្រាក់កក់ចំនួន $  <b><?php echo e(number_format ( $book->amount,2)); ?></b><b>(​<?php echo e(AppHelper::khNumberWord( $book->amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($book->date)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($book->date)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($book->date)))); ?></b>។
																				</td>
																			</tr>
																		<?php
														...
														foreach($loans as $loan)
														{
															...
															if($loan_count>$i)
															{
																...
																<tr>
																	<td align="left" style="font-family: 'Khmer OS system">
																&emsp;&emsp; <b>៤.១.<?php echo e(AppHelper::khMultipleNumber($i)); ?>. ដំណាក់កាលទី <?php echo e(AppHelper::khMultipleNumber($i)); ?></b> ៖ ភាគី “ខ” យល់ព្រមបង់ប្រាក់បន្ថែមចំនួន​ $ <b><?php echo e(number_format( $loan->loan_amount,2 )); ?></b> <b>(​<?php echo e(AppHelper::khNumberWord($loan->loan_amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($loan->loan_date)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($loan->loan_date)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($loan->loan_date)))); ?></b>។
																	</td>
																</tr>
															<?php
															}else{
																?>
																	<tr>
																		<td align="left" style="font-family: 'Khmer OS system">
																	&emsp;&emsp; <b>៤.១.<?php echo e(AppHelper::khMultipleNumber($i)); ?>.	ដំណាក់កាលទី <?php echo e(AppHelper::khMultipleNumber($i)); ?></b> ៖ ភាគី “ខ” នឹងបង់ប្រាក់ដែលនៅសល់បង្រ្គប់ចំនួន $ <b><?php echo e(number_format( $loan->loan_amount,2)); ?> </b>  <b>(​<?php echo e(AppHelper::khNumberWord( $loan->loan_amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime(	$effectiveDate)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime(	$effectiveDate)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime(	$effectiveDate)))); ?></b> ហើយភាគី “ក” ត្រូវបញ្ចប់ការសាងសង់ និងកាត់ឈ្មោះផ្ទេរកម្មសិទ្ធិរួចរាល់ជាស្ថាពរឲ្យទៅភាគី“ខ” ហើយភាគី “ក” ត្រូវប្រគល់ប័ណ្ណកម្មសិទ្ធិដែលបានផ្ទេរសិទ្ធិទៅភាគី “ខ” រួចរាល់នោះ ឲ្យទៅភាគី “ខ” ។
																		</td>
																	</tr>
																<?php
															}
							...
							<td align="left"​ style="font-family: 'Khmer OS Muol Light';">
								...
								<tr>
									<td align="left" style="font-family: 'Khmer OS System';">&emsp;&emsp; ១-បន្ថែម  &emsp;&emsp;<b><?php echo e($sale->product_first); ?></b></td>
								</tr>
								<tr>
									<td align="left" style="font-family: 'Khmer OS System';">&emsp;&emsp; ២-បន្ថែម  &emsp;&emsp;<b><?php echo e($sale->product_second); ?></b></td>
								</tr>
								<tr>
									<td align="left" style="font-family: 'Khmer OS System';">&emsp;&emsp; ៣-បន្ថែម  &emsp;&emsp;<b><?php echo e($sale->product_third); ?></b></td>
								</tr>
								<tr>
									<td align="left" style="font-family: 'Khmer OS System';">&emsp;&emsp; ៤-បន្ថែម   &emsp;&emsp;<b><?php echo e($sale->product_four); ?></b></td>
								</tr>
								<tr>
									<td align="left" style="font-family: 'Khmer OS System';">&emsp;&emsp; ៥-បន្ថែម   &emsp;&emsp;<b><?php echo e($sale->product_five); ?></b></td>
								</tr>
							</tr>
						<td align="left"​ style="font-family: 'Khmer OS Muol Light';">
						...
						<tr>
							<td align="left"style="font-family: 'Khmer OS System';">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <b>- ជម្រាបជូន</b> ៖ លោក <b> <?php echo e($sale->customer_name); ?></b> </td>
						</tr>
						<tr>
							<td align="left"style="font-family: 'Khmer OS System';">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <b>- មានអាស័យដ្ឋាន</b> ៖ ផ្លូវលេខ <b><?php echo e($sale->street_number); ?></b> ផ្ទះលេខ <b><?php echo e($sale->cs_house_n); ?></b>  ភូមិ <b> <?php echo e($sale-> vil_kh); ?>  </b> ឃុំ/សង្កាត់ <b><?php echo e($sale->com_kh); ?></b>  ​ស្រុក/ខណ្ឌ <b><?php echo e($sale->dis_kh); ?></b> រាជធានី/ខេត្ត <b><?php echo e($sale->prov_name); ?></b> </td>
						</tr>
						<tr>
							<td align="left"style="font-family: 'Khmer OS System';">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <b>- លេខទូរស័ព្ទ</b> ៖ <?php echo e($sale->phone1 .' / '. $sale->phone2); ?>  </td>
						</tr>
						<tr>
						...
						<tr>
							<td align="left"style="font-family: 'Khmer OS System';">&emsp;&emsp;&emsp;&emsp; <b>-និងរក្សាទុកនៅការិយាល័យមេធាវីចំនួន០១ ច្បាប់។</b> </td>
										...
										<table class="text-center" style="width:100%;font-size:15px;height:350px;margin-top:-70px;font-family:Khmer OS System">
											...
											<td>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;​ <b><?php echo e($sale->customer_name); ?></b> <br> <span style="font-family: Khmer OS System;font-weight:bold;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(ភាគីអ្នកទិញ)</span></td>
											</tr>
										</table>
										...
										<tr>
											<td ><p style="font-size:16px;font-family:Khmer OS System;margin-left:33%"> ធ្វើនៅសៀមរាប, ថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->created_at)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($sale->created_at)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->created_at)))); ?></b> <br> ភាគីឲបង់រំលស់​ តំណាង-ក្រុម​ហ៊ុន រដ្ឋ ស៊ីង អចលនទ្រព្យ</p> </td>
										</tr>
										<tr>
						...
						<br><br><br><br>
										<div class="form-group">
											<hr>
											<button class="btn btn-lg btn-success pull-right" onclick="printFuncsTion();"><i class="fa fa-print" aria-hidden="true"></i><?php echo e(__('item.print_this_page')); ?></button>
												...
												<div class="content">
													...
													<tbody>
														<tr>
															...
															<tr><td><p></p></td></tr>
															<tr>
																<td style="text-decoration: underline;font-family: 'Khmer OS Muol Light';font-size:20px">លិខិតទិញ-លក់<?php echo e($sale->p_name); ?></td>
															</tr>
														</tr>
														<tr>
															<td>
																<p class="p" style="text-align: justify;">&emsp;&emsp;&emsp;​ខ្ញុំបាទ/នាងខ្ញុំ៖ ឈ្មោះ​ <b style="font-family: 'Khmer OS Muol Light';">សាន្ត រដ្ឋស៊ីង </b> ភេទ ប្រុស អាយុ 37 ឆ្នាំ   កាន់អត្តសញ្ញាណប័ណ្ណសញ្ជាតិខ្មែរ​​ លេខ ០៣០៦០៣៥២៩ ចុះថ្ងៃទី១៥ ខែវិច្ឆិកា ឆ្នាំ២០១៥ មានអាសយដ្ឋានបច្ចុប្បន្ននៅភូមិគោកធ្លក ឃុំកណ្តែក ស្រុកប្រាសាទបាគង ខេត្តសៀមរាប ចាប់ពីពេលនេះតទៅ នៅក្នុងកិច្ចសន្យានេះហៅកាត់ថា ភាគី “ក” ។ </p>
															</td>
														</tr>
																		<?php
													if($child_item!==[])
													{
															...
															foreach($child_item as $c)
														{
															...
															<tr>
																<td>
																	<p align="left"​ style="text-align: justify;">&emsp;&emsp;&emsp;ខ្ញុំបាទ/នាងខ្ញុំ បានព្រមព្រៀងគ្នាលក់ដី <b><?php echo e($c->property_name); ?></b>  ចំនួន​​ ១ កន្លែង មានក្បាលដីលេខ <b><?php echo e($c->land_num); ?></b>  បណ្តោយ <b><?php echo e($c->length); ?></b> ម៉ែត្រ   ទទឹង <b><?php echo e($c->width); ?></b> ម៉ែត្រ ទំហំសរុបចំនួន <b><?php echo e($c->ground_surface); ?></b> ម៉ែត្រការ៉េ សិ្ថតក្នុង ផ្លូវលេខ <b><?php echo e($c->address_street); ?></b>​ ផ្ទះលេខ <b><?php echo e($c->address_number); ?></b>  ភូមិ <b><?php echo e($c->village); ?></b> ឃុំ/សង្កាត់ <b><?php echo e($c->commune); ?></b>  ស្រុក/ខណ្ឌ <b><?php echo e($c->district); ?></b> ខេត្ត/ក្រុង <b><?php echo e($c->province); ?></b> ។ 
																</td>
															</tr>
														<?php
														}	
															...
															<tr>
																<td>
																	<p align="left"​ style="text-align: justify;font-family: Khmer OS System">&emsp;&emsp;&emsp;ខ្ញុំបាទ/នាងខ្ញុំ បានព្រមព្រៀងគ្នាលក់ដី <b><?php echo e($sale->property_name); ?></b>  ចំនួន​​ ១ កន្លែង មានក្បាលដីលេខ <b><?php echo e($sale->land_num); ?></b>  បណ្តោយ <b><?php echo e($sale->length); ?></b> ម៉ែត្រ   ទទឹង <b><?php echo e($sale->width); ?></b> ម៉ែត្រ ទំហំសរុបចំនួន <b><?php echo e($sale->gf); ?></b> ម៉ែត្រការ៉េ សិ្ថតក្នុង ភូមិ <b><?php echo e($sale->village); ?></b> ឃុំ/សង្កាត់ <b><?php echo e($sale->commune); ?></b>  ស្រុក/ខណ្ឌ <b><?php echo e($sale->district); ?></b> ខេត្ត/ក្រុង <b><?php echo e($sale->province); ?></b> ។ ក្នុងតម្លៃ <b>$ <?php echo e($sale->p_pp - $sale->discount_amount); ?></b> (បញ្ចុះតម្លៃរួច)​ ដែលមានលេខឡូតិ៍.........។​ដែលមានព្រំប្រទល់  ខាងជេីងទល់នឹង <b><?php echo e($sale->boundary_north); ?>  ខាងត្បូងទល់នឹង <b><?php echo e($sale->boundary_south); ?> </b>​​  ​ខាងកើតទល់នឹង <b><?php echo e($sale-> boundary_east); ?></b>​​  ខាងលិចទល់នឹង <b><?php echo e($sale->boundary_west); ?> </b>
																</td>
															</tr>
															<?php
															}?>
															<tr>
																<td>
																	<p align="left"​ style="text-align: justify;font-family: Khmer OS System">&emsp;&emsp;&emsp;ឲ្យទៅឈ្មោះ <span style="font-family: 'Khmer OS Muol Light';"><b><?php echo e($sale->customer_name); ?></b></span> ភេទ <b><?php echo e($sale->customer_gender); ?> </b>កើតឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->customer_date_of_birht)))); ?> </b>សញ្ជាតិ <b><?php echo e($sale->customer_nationality); ?></b>  មានអត្តសញ្ញាណប័ណ្ណសញ្ជាតិខ្មែរលេខៈ <b><?php echo e(AppHelper::khMultipleNumber((string)$sale->customer_identity)); ?></b>  ចុះថ្ងៃទី  <b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->cs_ident)))); ?> </b> ខែ  <b><?php echo e(AppHelper::khMultipleNumber(date('m', strtotime($sale->cs_ident)))); ?> </b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->cs_ident)))); ?> </b>អាស័យដ្ឋានបច្ចុប្បន្ន ផ្ទះលេខ <b><?php echo e($sale->cs_house_n); ?></b>  ភូមិ <b> <?php echo e($sale-> vil_kh); ?>  </b> ឃុំ/សង្កាត់ <b><?php echo e($sale->com_kh); ?></b> ស្រុក/ខណ្ឌ <b><?php echo e($sale->dis_kh); ?> </b>ក្រុង/ខេត្ត <b><?php echo e($sale->prov_name); ?></b> លេខទូរស័ព្ទ <b><?php echo e($sale->phone1); ?></b>។ តទៅហៅកាត់ភាគី (ខ) </p> 
																</td>
															</tr>
															<tr>
														...
														if($sale->deposit<=0)
														{
															...
															?>
																<tr>
																	<td align="left" style="font-family: 'Khmer OS system">
																&emsp;&emsp;​​​​​​​​​​ <b>១.<?php echo e(AppHelper::khMultipleNumber($i)); ?>. ដំណាក់កាលទី <?php echo e(AppHelper::khMultipleNumber($i)); ?></b>  ៖ ភាគី “ខ” យល់ព្រមបង់ប្រាក់កក់ចំនួន $  <b><?php echo e(number_format( $reservation->amount,2 )); ?></b><b>(​<?php echo e(AppHelper::khNumberWord( $reservation->amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($reservation->date_booked)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($reservation->date_booked)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($reservation->date_booked)))); ?></b>។
																	</td>
																</tr>
																<!-- get book details -->
																<?php
																	foreach($book_details as $book)
																	{
																		...
																		?>
																			<tr>
																				<td align="left" style="font-family: 'Khmer OS system">
																			&emsp;&emsp;​​​​​​​​​​ <b>១.<?php echo e(AppHelper::khMultipleNumber($i)); ?>. ដំណាក់កាលទី <?php echo e(AppHelper::khMultipleNumber($i)); ?></b>  ៖ ភាគី “ខ” យល់ព្រមបង់ប្រាក់កក់ចំនួន $  <b><?php echo e(number_format ( $book->amount,2)); ?></b><b>(​<?php echo e(AppHelper::khNumberWord( $book->amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($book->date)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($book->date)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($book->date)))); ?></b>។
																				</td>
																			</tr>
																		<?php
														...
														foreach($loans as $loan)
														{
															...
															if($loan_count>$i)
															{
																...
																<tr>
																	<td align="left" style="font-family: 'Khmer OS system">
																&emsp;&emsp; <b>១.<?php echo e(AppHelper::khMultipleNumber($i)); ?>. ដំណាក់កាលទី <?php echo e(AppHelper::khMultipleNumber($i)); ?></b> ៖ ភាគី “ខ” យល់ព្រមបង់ប្រាក់បន្ថែមចំនួន​ $ <b><?php echo e(number_format( $loan->loan_amount,2 )); ?></b> <b>(​<?php echo e(AppHelper::khNumberWord($loan->loan_amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($loan->loan_date)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($loan->loan_date)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($loan->loan_date)))); ?></b>។
																	</td>
																</tr>
															<?php
															}else{
																?>
																	<tr>
																		<td align="left" style="font-family: 'Khmer OS system">
																	&emsp;&emsp; <b>១.<?php echo e(AppHelper::khMultipleNumber($i)); ?>.	ដំណាក់កាលទី <?php echo e(AppHelper::khMultipleNumber($i)); ?></b> ៖ ភាគី “ខ” នឹងបង់ប្រាក់ដែលនៅសល់បង្រ្គប់ចំនួន $ <b><?php echo e(number_format( $loan->loan_amount,2)); ?> </b>  <b>(​<?php echo e(AppHelper::khNumberWord($loan->loan_amount)); ?>) ដុល្លារអាមេរិកគត់</b> ឲ្យទៅភាគី “ក” នៅថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime(	$effectiveDate)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime(	$effectiveDate)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime(	$effectiveDate)))); ?></b> ហើយភាគី “ក” ត្រូវបញ្ចប់ការសាងសង់ និងកាត់ឈ្មោះផ្ទេរកម្មសិទ្ធិរួចរាល់ជាស្ថាពរឲ្យទៅភាគី“ខ” ហើយភាគី “ក” ត្រូវប្រគល់ប័ណ្ណកម្មសិទ្ធិដែលបានផ្ទេរសិទ្ធិទៅភាគី “ខ” រួចរាល់នោះ ឲ្យទៅភាគី “ខ” ។
																		</td>
																	</tr>
																<?php
															}
														...
														?>
															...
															<tr>
																<td align="left" style="text-align: justify;font-family:Khmer OS"​>-ថែមជូន: <b><?php echo e($sale->product_first); ?></b></td>
															</tr>
															<tr>
																<td align="left"​ style="text-align: justify;font-family:Khmer OS">-ថែមជូន: <b><?php echo e($sale->product_second); ?></b></td>
															</tr>
															<tr>
																<td align="left" style="text-align: justify;font-family:Khmer OS"​>-ថែមជូន: <b><?php echo e($sale->product_third); ?></b></td>
															</tr>
															<tr>
																<td align="left"​ style="text-align: justify;font-family:Khmer OS">-ថែមជូន: <b><?php echo e($sale->product_four); ?></b></td>
															</tr>
															<tr>
																<td align="left"​ style="text-align: justify;font-family:Khmer OS">-ថែមជូន: <b><?php echo e($sale->product_five); ?></b> </td>
															</tr>
															<tr>
															...
															<tr>
																<td style="font-family:Khmer OS">ធ្វើនៅសៀមរាប ថ្ងៃទី<b><?php echo e(AppHelper::khMultipleNumber(date('d', strtotime($sale->created_at)))); ?> </b>ខែ <b><?php echo e(AppHelper::khMonth(date('m', strtotime($sale->created_at)))); ?></b>  ឆ្នាំ <b><?php echo e(AppHelper::khMultipleNumber(date('Y', strtotime($sale->created_at)))); ?></b></td>
															</tr>
															<tr>
																<td></td>
															</tr>
															<tr>
																...
																<table style="width:90%;font-size:15px;height:350px;margin-top:-100px;font-family:Khmer OS System">
																	...
																	<td>&emsp;&emsp;-------------------------</td>
																	<td>&emsp;&emsp;-------------------------</td>
																	<td>&emsp;&emsp;&emsp;&emsp;<b><?php echo e($sale->customer_name); ?></b></td>
																	</tr>
																	</table>
...
<?php $__env->startSection('script'); ?>
	<script>
		...
		function printFunc() {
	    	...
	    	var fontUrl = "<?php echo e(asset('public/back-end/fonts/print-font/KhmerOSmuollight.ttf')); ?>";
	    	var font_khsys_url = "<?php echo e(asset('public/back-end/fonts/print-font/KhmerOSsys.ttf')); ?>";
	    	var css = '' +
